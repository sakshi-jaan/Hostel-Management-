...
if(isset($Submit))
{
$max_qry=mysqli_query($connect,"select max(id) from fees_det");
$max_row=mysqli_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;

$tot=$mess*$days;
$qrys=mysqli_query($connect,"insert into fees_det values('$id','$month','$days','$mess','$tot')");
 echo( "Total Fee: $tot" );
if($qrys)
{
?>
		...
		<div class="container">
		  <form name="form" method="post" action="">
		    <table width="515" height="235" border="0" align="center">
              ...
              <?php 
	$xyz=mysqli_query($connect,"select * from fees_det ");

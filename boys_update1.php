...
$qqry=mysql_query("update boys set Student_Id='$sid',Roll='$roll',Room='$room',Name='$name',Age='$age',Year='$year',Contact='$contact',Address='$add' where Id='$id'");
if($qqry)
{
?>
<script language="javascript">
	alert("modified Successfully..");
	window.location.href="boys_update.php";
	</script>
	<?php
}
else
...
window.location.href="boyss_update.php";
</script>
	<?php
}
...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
		   <?php 
	$xyz=mysql_query("select * from boys where Id='$id' ");

...
if(isset($Submit))
{
$max_qry=mysqli_query($connect,"select max(id) from girls");
$max_row=mysqli_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;

$qrys=mysqli_query($connect,"insert into girls values('$id','$sid','$roll','$room','$name','$age','$dept','$year','$mail','$contact','$addr','$uname','$pwd')");

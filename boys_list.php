...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
            ...
            <table width="263" height="95" border="0" align="center">
              <tr>
                <td width="106"><div align="center" class="badge style9">ROLL NUMBER </div></td>
                <td width="79" height="91"><div align="center" class="style9">
                    <select name="select">
                      <?php 
		$xyz=mysql_query("select DISTINCT Roll from boys");
	   ...
	   ?>
            ...
            <table width="944" height="130" border="2" align="center">
              <tr>
                <td width="189" height="51"><div align="center" class="style9">                  <strong>REGISTER NUMBER </strong></div></td>
                <td width="161"><div align="center" class="style9">                  <strong>ROLL NUMBER </strong></div></td>
                <td width="164"><div align="center" class="style9">                  <strong>NAME</strong></div></td>
                <td width="169"><div align="center" class="style9">                  <strong>ROOM NUMBER </strong></div></td>
                <td width="239"><div align="center" class="style9">                  <strong>ADDRESS</strong></div></td>
              </tr>
              <?php
	if(isset($_POST['submit']))
	{ 
	$xyz=mysql_query("select * from boys where Roll='$select'");
while(	$row=mysql_fetch_array($xyz))
{
?>
              <tr>
                <td class="bg-warning"><div align="center" class="style8"><?php echo $row["Student_Id"];?></div></td>
                <td class="bg-warning"><div align="center" class="style8"><?php echo $row["Roll"];?></div></td>
                <td class="bg-warning"><div align="center" class="style8"><?php echo $row["Name"];?></div></td>
                <td class="bg-warning"><div align="center" class="style8"><?php echo $row["Room"];?></div></td>
                <td class="bg-warning"><div align="center" class="style8"><?php echo $row["Address"];?></div></td>
              </tr>
              <?php 
	}
	}

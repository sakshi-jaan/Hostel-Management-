...
<li class="active"><a href="#" class="dropdown-toggle link link--yaku" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>STUDENT VIEW</span> <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="girls_bill1.php" class="link link--yaku"><span>GIRLS HOSTEL</span></a></li>
...
<div class="gallery w3-agileits">  
		<div class="container">
		  <blockquote>
		    <form name="form1" method="post" action="girls_bill1.php">
		      <table width="418" height="95" border="0" align="center">
                <tr>
                  <td width="122"><div align="center" class="badge-primary">
                    <div align="center" class="bg-info">ROLL NUMBER </div>
                  </div></td>
                  <td width="118" height="91"><div align="center" class="style9">
                    <label>
                  ...
                  <td width="79"><div align="center"><a href="girls_bill1.php" target="_blank">
                    <label>

		    ...
		    <form name="form1" method="post" action="boys_invoice.php">
		      ...
		      <table width="451" height="257" border="0" align="center">
                <tr>
				  ...
				  <?php $xyz=mysqli_query($connect,"select DISTINCT Student_Id from boys where Roll='$roll'");
                ...
                <tr>
				  ...
				  <?php $xyz=mysqli_query($connect,"select DISTINCT Roll from boys where Roll='$roll'");
						$row=mysqli_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				    <?php $xyz=mysqli_query($connect,"select DISTINCT Room from boys where Roll='$roll'");
						$row=mysqli_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				   <?php $xyz=mysqli_query($connect,"select DISTINCT Name from boys where Roll='$roll'");
						$row=mysqli_fetch_array($xyz);
                ...
                <tr>
                  ...
                  <td class="list-group-item-success"><div align="center">
				  <?php $xyz=mysqli_query($connect,"select DISTINCT Year from boys where Roll='$roll'");
						$row=mysqli_fetch_array($xyz);

...
<div class="gallery w3-agileits">  
		<div class="container">
		  <form name="form1" method="post" action="">
            ...
            <table width="467" height="95" border="0" align="center">
              <tr>
                <td width="162"><div align="center" class="badge style9">ROLL NUMBER </div></td>
                <td width="147" height="91"><div align="center">
                    <select name="select">
                      <?php 
		$xyz=mysql_query("select DISTINCT Roll from girls");
	...
	{ 
	$xyz=mysql_query("select * from girls where Roll='$select'");
while(	$row=mysql_fetch_array($xyz))
{
?>
              <tr>
